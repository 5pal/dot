return {
  ...
  },
  {
    ...
    config = function()
      ...
      vim.api.nvim_set_hl(0, "TSKeywordFunction", { fg = "#f2594b", italic = true })
      vim.api.nvim_set_hl(0, "TSConditional", { fg = "#f2594b", italic = true })
      ...
      -- vim.api.nvim_set_hl(0, "TSConstant", { italic = false, bold = false }) -- 상수 스타일 수정

      -- remove ErrorMsg underline
